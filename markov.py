...
class Markov:
    ...
    def predict(self, data_in):
        """This is a method of the Markov class"""
...
class WordMarkov(Markov):
    ...
    def _get_table(self, data_in):
        #parent = super()._get_table(data_in)
        for table in self.tables:
            if data_in in table:
                return table
        print(f"Missing table :{data_in}")

def get_table(line, size=1):
    """This is a function, it is not a method of Markov"""
    results = {}
